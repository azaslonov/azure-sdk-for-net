...
{
    public partial class Sample_EnvironmentCollection
    {
        ...
        public async Task GetAll_EnvironmentsListByWorkspace()
        {
            ...
            // get the collection of this EnvironmentResource
            EnvironmentCollection collection = workspace.GetEnvironments();

            // invoke the operation and iterate over the result
            await foreach (EnvironmentResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                EnvironmentData resourceData = item.Data;
        ...
        public async Task Get_EnvironmentsGet()
        {
            ...
            EnvironmentResource result = await collection.GetAsync(environmentName);
        ...
        public async Task GetIfExists_EnvironmentsGet()
        {
            ...
            // invoke the operation
            string environmentName = "public";
            NullableResponse<EnvironmentResource> response = await collection.GetIfExistsAsync(environmentName);
            EnvironmentResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_EnvironmentsCreateOrUpdate()
        {
            ...
            ArmOperation<EnvironmentResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, environmentName, data);
