...
{
    public partial class Sample_ApiDefinitionResource
    {
        // ApiDefinitions_Get
        ...
        public async Task Get_ApiDefinitionsGet()
        {
            ...
            // this example assumes you already have this ApiDefinitionResource created on azure
            // for more information of creating ApiDefinitionResource, please refer to the document of ApiDefinitionResource
            ...
            ResourceIdentifier apiDefinitionResourceId = ApiDefinitionResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, serviceName, workspaceName, apiName, versionName, definitionName);
            ApiDefinitionResource apiDefinition = client.GetApiDefinitionResource(apiDefinitionResourceId);

            // invoke the operation
            ApiDefinitionResource result = await apiDefinition.GetAsync();
        ...
        public async Task Update_ApiDefinitionsCreateOrUpdate()
        {
            ...
            ArmOperation<ApiDefinitionResource> lro = await apiDefinition.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task Delete_ApiDefinitionsDelete()
        {
            ...
            // invoke the operation
            await apiDefinition.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Head_ApiDefinitionsHead()
        {
            ...
            // invoke the operation
            bool result = await apiDefinition.HeadAsync();
        ...
        public async Task ExportSpecification_ApiDefinitionsExportSpecification()
        {
            ...
            // invoke the operation
            ArmOperation<ApiSpecExportResult> lro = await apiDefinition.ExportSpecificationAsync(WaitUntil.Completed);
        ...
        public async Task ImportSpecification_ApiDefinitionsImportSpecification()
        {
            ...
            await apiDefinition.ImportSpecificationAsync(WaitUntil.Completed, content);
