...
{
    public partial class Sample_ApiVersionResource
    {
        // ApiVersions_Get
        ...
        public async Task Get_ApiVersionsGet()
        {
            ...
            ApiVersionResource result = await apiVersion.GetAsync();
        ...
        public async Task Update_ApiVersionsCreateOrUpdate()
        {
            ...
            ArmOperation<ApiVersionResource> lro = await apiVersion.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task Delete_ApiVersionsDelete()
        {
            ...
            // invoke the operation
            await apiVersion.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Head_ApiVersionsHead()
        {
            ...
            // invoke the operation
            bool result = await apiVersion.HeadAsync();
