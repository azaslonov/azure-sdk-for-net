...
{
    public partial class Sample_DeploymentResource
    {
        // Deployments_Get
        ...
        public async Task Get_DeploymentsGet()
        {
            ...
            // this example assumes you already have this DeploymentResource created on azure
            // for more information of creating DeploymentResource, please refer to the document of DeploymentResource
            ...
            ResourceIdentifier deploymentResourceId = DeploymentResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, serviceName, workspaceName, apiName, deploymentName);
            DeploymentResource deployment = client.GetDeploymentResource(deploymentResourceId);

            // invoke the operation
            DeploymentResource result = await deployment.GetAsync();
        ...
        public async Task Update_DeploymentsCreateOrUpdate()
        {
            ...
            ArmOperation<DeploymentResource> lro = await deployment.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task Head_DeploymentsHead()
        {
            ...
            // invoke the operation
            bool result = await deployment.HeadAsync();
