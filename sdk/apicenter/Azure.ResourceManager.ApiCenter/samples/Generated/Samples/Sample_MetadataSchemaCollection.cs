...
{
    public partial class Sample_MetadataSchemaCollection
    {
        ...
        public async Task GetAll_MetadataSchemasListByService()
        {
            ...
            // get the collection of this MetadataSchemaResource
            MetadataSchemaCollection collection = apiCenterService.GetMetadataSchemas();

            // invoke the operation and iterate over the result
            await foreach (MetadataSchemaResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                MetadataSchemaData resourceData = item.Data;
        ...
        public async Task Get_MetadataSchemasGet()
        {
            ...
            MetadataSchemaResource result = await collection.GetAsync(metadataSchemaName);
        ...
        public async Task GetIfExists_MetadataSchemasGet()
        {
            ...
            // invoke the operation
            string metadataSchemaName = "lastName";
            NullableResponse<MetadataSchemaResource> response = await collection.GetIfExistsAsync(metadataSchemaName);
            MetadataSchemaResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_MetadataSchemasCreateOrUpdate()
        {
            ...
            ArmOperation<MetadataSchemaResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, metadataSchemaName, data);
