...
namespace Azure.ResourceManager.ApiCenter.Samples
{
    public partial class Sample_ApiCollection
    {
        ...
        public async Task GetAll_ApisListByWorkspace()
        {
            ...
            ApiCollection collection = workspace.GetApis();
        ...
        public async Task Get_ApisGet()
        {
            ...
            ApiResource result = await collection.GetAsync(apiName);
        ...
        public async Task GetIfExists_ApisGet()
        {
            ...
            // invoke the operation
            string apiName = "echo-api";
            NullableResponse<ApiResource> response = await collection.GetIfExistsAsync(apiName);
        ...
        public async Task CreateOrUpdate_ApisCreateOrUpdate()
        {
            ...
            ArmOperation<ApiResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, apiName, data);
