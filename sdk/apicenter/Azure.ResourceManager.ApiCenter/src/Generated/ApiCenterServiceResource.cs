...
namespace Azure.ResourceManager.ApiCenter
{
    ...
    public partial class ApiCenterServiceResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of MetadataSchemaResources in the ApiCenterService. </summary>
        /// <returns> An object representing collection of MetadataSchemaResources and their operations over a MetadataSchemaResource. </returns>
        public virtual MetadataSchemaCollection GetMetadataSchemas()
        {
            return GetCachedClient(client => new MetadataSchemaCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<MetadataSchemaResource>> GetMetadataSchemaAsync(string metadataSchemaName, CancellationToken cancellationToken = default)
        {
            return await GetMetadataSchemas().GetAsync(metadataSchemaName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="metadataSchemaName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<MetadataSchemaResource> GetMetadataSchema(string metadataSchemaName, CancellationToken cancellationToken = default)
        {
            return GetMetadataSchemas().Get(metadataSchemaName, cancellationToken);
        }

        /// <summary> Gets a collection of WorkspaceResources in the ApiCenterService. </summary>
