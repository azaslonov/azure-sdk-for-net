...
namespace Azure.ResourceManager.ApiCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiSpecImportRequestSpecification>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApiSpecImportRequestSpecification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiSpecImportRequestSpecification)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ApiSpecImportRequestSpecification>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApiSpecImportRequestSpecification)} does not support '{options.Format}' format.");
            }
        }
