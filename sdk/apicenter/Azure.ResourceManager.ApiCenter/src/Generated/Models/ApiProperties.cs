...
namespace Azure.ResourceManager.ApiCenter.Models
{
    ...
    public partial class ApiProperties
    {
        ...
        public ApiProperties(string title, ApiKind kind)
        {
        ...
        internal ApiProperties(string title, ApiKind kind, string description, string summary, LifecycleStage? lifecycleStage, TermsOfService termsOfService, IList<ExternalDocumentation> externalDocumentation, IList<Contact> contacts, License license, BinaryData customProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
            Kind = kind;
        ...
        /// <summary> Initializes a new instance of <see cref="ApiProperties"/> for deserialization. </summary>
        internal ApiProperties()
        {
        }
        ...
        public IList<ExternalDocumentation> ExternalDocumentation { get; }
