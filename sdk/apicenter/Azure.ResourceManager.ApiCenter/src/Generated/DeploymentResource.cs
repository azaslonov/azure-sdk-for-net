...
namespace Azure.ResourceManager.ApiCenter
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ApiResource"/> using the GetDeployment method.
    /// </summary>
    public partial class DeploymentResource : ArmResource
    {
        ...
        {
            _deploymentClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiCenter", ResourceType.Namespace, Diagnostics);
        ...
        {
            using var scope = _deploymentClientDiagnostics.CreateScope("DeploymentResource.Head");
            scope.Start();
            try
            {
                var response = await _deploymentRestClient.HeadAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> Head(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _deploymentRestClient.Head(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
